        ...
        loginForm.onsubmit = async (e) => {
            ...
            switch (result) {
                case 'no name':
                    ...
                    document.querySelector('.spinner-box').classList.add('active');
                    document.querySelector('.spin-horizontal').classList.add('active');
                    setTimeout(() => {
                        name.classList.remove('active');
                        document.querySelector('.spinner-box').classList.remove('active');
                        document.querySelector('.spin-horizontal').classList.remove('active');
                    }, 1500);
                    break;
                case 'no password':
